  ...
  return (
    ...
    <div className='flex min-h-[100dvh] flex-col bg-cream' id='top'>
      ...
      <div className='relative flex flex-col items-center overflow-y-auto overflow-x-hidden'>
        ...
        {/* WhatsApp Button */}
        <a
          className='fixed right-4 bottom-4 flex items-center gap-x-2 rounded-full bg-[#22CE62] px-3 py-3 text-white shadow-premium transition-all duration-200 hover:scale-102 hover:cursor-pointer hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage-light focus-visible:ring-offset-2 sm:px-6 lg:right-8 lg:bottom-8'
          href={WHATSAPP_LINK}
          target='_blank'
